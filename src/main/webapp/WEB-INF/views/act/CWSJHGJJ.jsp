            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/CWSJHGJJ/upload" 
                        ...
                        <a class="mini-button" iconCls="icon-download" href="<%=basePath %>/CWSJHGJJ/download" plain="true">EXCEL导出</a>
                    </td>
                </tr>
            </table>           
        </div>
