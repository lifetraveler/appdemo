...
<title>In_2_2_1</title>
<style type="text/css">
</style>
</head>
<body>
	<h1>表5 2011年末参保职工人均缴费年限（含视同）情况（中人）</h1>
	<div style="width:1100px;">
        <div class="mini-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                    	<form action="<%=basePath %>/input/2_2_1/upload" method="post" enctype="multipart/form-data">
	                        ...
	                        <span class="separator"></span>
	                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/input/inner_2_1/upload" 
	...
	<div id="datagrid1" class="mini-datagrid" style="width:1100px;height:500px;" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" fitColumns="false" showFooter="false" url="<%=basePath%>/input/2_2_1/list">
