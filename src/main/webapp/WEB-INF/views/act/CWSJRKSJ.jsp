            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/CWSJRKSJ/upload" 
                        ...
                        <a class="mini-button" iconCls="icon-download" href="<%=basePath %>/CWSJRKSJ/download" plain="true">EXCEL导出</a>
                    </td>
                </tr>
            </table>           
        </div>
		...
		<div property="columns">
			...
			<div header="按年龄分" headerAlign="center">
				<div property="columns">
					<div header="#0-14岁">
						<div property="columns">
							<div field="c3" width="100" headerAlign="center">万人
								<input property="editor" class="mini-spinner" allowLimitValue=false  decimalPlaces="2" style="width:100%;"/>
							</div>
						</div>
					</div>
					<div header="#15-59岁" headerAlign="center">
						<div property="columns">
							<div field="c4" width="100" headerAlign="center">万人
								<input property="editor" class="mini-spinner" allowLimitValue=false  decimalPlaces="2" style="width:100%;"/>
							</div>
						</div>
					</div>
