...
<title>CNNSDDYQ</title>
<style type="text/css">
</style>
</head>
<body >
	<h1>基本养老保险基金总支出及财政到帐同比增减情况表</h1>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/CNNSDDYQ/upload" 
                        ...
                        <a class="mini-button" iconCls="icon-download" href="<%=basePath %>/CNNSDDYQ/download" plain="true">EXCEL导出</a>
                    </td>
                </tr>
            </table>           
        </div>
