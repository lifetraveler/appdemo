...
<body >
	...
	<div id="datagrid1" class="mini-datagrid" style="width:900px;height:300px;" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true"  showFooter="false"
	url="<%=basePath%>/${MENUID}/list" >
		<div property="columns">
			...
			<div header="其中：事业机关" headerAlign="center">
				<div property="columns">
					<div header="2011年" headerAlign="center">
						<div property="columns">
