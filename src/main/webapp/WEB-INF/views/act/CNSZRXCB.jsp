            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/CNSZRXCB/upload" 
                        ...
                        <a class="mini-button" iconCls="icon-download" href="<%=basePath %>/CNSZRXCB/download" plain="true">EXCEL导出</a>
                    </td>
                </tr>
            </table>           
        </div>
    </div>
	<div id="datagrid1" class="mini-datagrid" style="width:1100px;height:500px;" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true" fitColumns="false" showFooter="false" 
	url="<%=basePath%>/CNSZRXCB/list">
		<div property="columns">
			<div field="location" width='0'></div>
			<div field="year" width='0'></div>
					...
					<div header="合计" headerAlign="center">
						<div property="columns">
							<div field="c2" width="100" headerAlign="center">1
								<input property="editor" class="mini-spinner" allowLimitValue=false  decimalPlaces="0" style="width:100%;"/>		
							</div>
						</div>
					</div>
				</div>
