...
<title>CNSZJZSX</title>
<style type="text/css">
</style>
</head>
<body>
	<h1>年末参保职工平均累计缴费工资指数情况（新人）</h1>
            ...
            <table style="width:100%;">
                <tr>
                    <td style="width:100%;">
                        ...
                        <span class="separator"></span>
                        <input id="fileupload1" class="mini-fileupload" name="Fdata" limitType="*.xls" flashUrl="<%=swfPath %>" uploadUrl="<%=basePath %>/CNSZJZSX/upload" 
                        ...
                        <a class="mini-button" iconCls="icon-download" href="<%=basePath %>/CNSZJZSX/download" plain="true">EXCEL导出</a>
                    </td>
                </tr>
            </table>           
        </div>
